...
const CheckoutItem = ({cartItem,clearItem,addItems,removeItem})=>{
    ...
    return(
        <div className="flex w-3/5 h-auto bg-white px-2 shadow-xl text-ms text-black">
            ...
            <div className="flex w-1/5 h-auto py-4 justify-center items-center ">
                <div onClick={()=>removeItem(cartItem)} className="flex px-2 cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-left"><polyline points="15 18 9 12 15 6"></polyline></svg></div>
                <div className="flex px-2 ">{quantity}</div>
                <div onClick={()=>addItems(cartItem)} className="flex px-2 cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg></div>
            </div>
